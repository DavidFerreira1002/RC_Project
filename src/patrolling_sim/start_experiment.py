...
import tkinter.messagebox	# Pyhton 3
#import tkMessageBox
import configparser		# Pyhton 3
#import ConfigParser
import _thread			# Python 3
#import thread
from tkinter import *		# Python 3
#from Tkinter import *
from tkinter.ttk import *	# Python 3
#from ttk import *
...
def loadInitPoses():
  try:
    ...
    print ("Could not load initial poses file") #parentheses are mandatory in Python 3
